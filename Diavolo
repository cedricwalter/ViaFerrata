...
You MUST sign the waiver form, it contains detailed information about the difficulty and more -> https://forms.gle/KUpZWbu1Bep8QnhA7

⏱️ Duration 3 hours total

☀️Weather: Weather can cancel the event a few days before or during if weather is not perfect for execution!
https://www.meteoschweiz.admin.ch/lokalprognose/andermatt/6490.html#forecast-tab=detail-view

📈 Difficulty: K2-3. +450m. Moderately difficult via ferrata, ideal for beginners. 

📍 Meeting Point:  06:45AM  Zürich HB, Main Meeting point, around the clock
Find the turquoise Zürich Together Banner.

🏁 Time of leaving:  7:00AM to platform 8
...
🏁 Start Andermatt (1436 m), station for the Furka-Oberalp-Bahn railway and terminus for the funicular coming up from Göschenen. Parking at the station. From the station at Andermatt, follow the route alongside and on the main road (route signed) through the Urner Loch into the Schöllenen gorge, turning right before you reach the Teufelsbrücke Bridge and making for the Suvorov Memorial (1,405 m).
🎯 End:  1900m
🚶🏻‍♂️ Exit: 1 hour On a well-signed path, first taking in a slight climb over the Tüfelstalboden, and then gently downhill to the avalanche obstructions, before zig-zagging down to the barracks area at  Andermatt.
