...
⏱️ Duration: Around 6 to 7 hours for the full round trip (approach, climb, and descent) ~1,195 meters total ascent profile
...
🚂 Recommended train: https://a.sbbmobile.ch/s/rGc6SpQI
To reach the Sulzfluh via ferrata by public transport, take the train to Küblis station, 
switch to the PostBus to St. Antönien, and hike or take the local Bus Alpin up to Partnun,
where the marked mountain trail leads to the base of the climb.
...
parking lots (such as P6 or further up toward Partnunstafel), from where you hike 1.5 to 2 hours to the start
St. Antönien / Partnun (Graubünden, Switzerland) / Rätikon 
...
🚶🏻‍♂️ Exit: After descending on a sign-posted normal path, one traverses the Gemschtobel (secured with chains), which has white-red-white signposts. Subsequently one descends further down to Partnun.
